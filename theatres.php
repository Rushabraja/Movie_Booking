							...
							<div class="half left-arrow d-flex align-items-center">
								<div class="text p-4 p-xl-5 text-center">
									...
									<ul class="list-accomodation">
										<li><span>Max:</span> <?php echo $theatre->num_persons; ?>Persons</li>
										<li><span>Size:</span> <?php echo $theatre->size; ?></li>
										<li><span>View:</span> <?php echo $theatre->view; ?></li>
										<li><span>Seats:</span> <?php echo $theatre->num_seats; ?></li>
									</ul>
									<p class="pt-1"><a href="theatres/theatre-single.php?id=<?php echo theatre->id; ?>" class="btn-custom px-3 py-2">View Theatre Details <span class="icon-long-arrow-right"></span></a></p>
								</div>
							</div>
						</div>
					</div>
